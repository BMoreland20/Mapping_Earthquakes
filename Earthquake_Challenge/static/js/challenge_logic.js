...
let tectonicplatelink = 'https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json';
...
let styleLines = {
  ...
  d3.json(tectonicplatelink).then(function(data) {
    console.log(data);
    L.geoJSON(data, {
      style: styleLines,
      onEachFeature: function(feature, layer) {
